...
class Smart_TOC_Admin {
    ...
    public function plugin_action_links( $links ) {
        ...
        $pro_link = '<a href="https://anikchowdhury.net/smart-toc-pro/" target="_blank" style="color:#00a32a;font-weight:600;">' . __( 'Get Pro', 'smart-table-of-contents' ) . '</a>';
    ...
    public function add_admin_menu() {
        add_options_page(
            __( 'Smart TOC Settings', 'smart-table-of-contents' ),
        ...
        <div class="wrap smart-toc-admin">
            ...
            <div class="smart-toc-pro-banner">
                <div class="pro-banner-content">
                    ...
                    <a href="https://anikchowdhury.net/smart-toc-pro/" target="_blank" class="button button-primary"><?php esc_html_e( 'Get Pro Version', 'smart-table-of-contents' ); ?></a>
                </div>
            </div>
            ...
            <form method="post" action="options.php">
                ...
                <div class="smart-toc-settings-grid">
                    ...
                    <div class="smart-toc-card smart-toc-pro-features">
                        ...
                        <a href="https://anikchowdhury.net/smart-toc-pro/" target="_blank" class="button button-primary"><?php esc_html_e( 'Unlock All Features', 'smart-table-of-contents' ); ?></a>
                    </div>
                </div>
