...
class Smart_TOC_Render {
	...
	private function build_toc_html( $items, $overrides = array() ) {
		...
		$html  = '<nav class="smart-toc' . esc_attr( $collapsed_class ) . '" aria-label="' . esc_attr__( 'Table of Contents', 'small-seo-engine-smart-toc' ) . '">';
		$html .= '<div class="smart-toc-header">';
		$html .= '<span class="smart-toc-title">' . esc_html( $title ) . '</span>';
		$html .= '<button class="smart-toc-toggle" aria-expanded="' . esc_attr( $aria_expanded ) . '" aria-label="' . esc_attr__( 'Toggle Table of Contents', 'small-seo-engine-smart-toc' ) . '">';
